...
class LLMResponseDebugger(tk.Tk):
    ...
    def _build_speech_tab(self, parent: ttk.Frame) -> None:
        ...
        ttk.Label(speech_options_frame, text="Expression").grid(
            row=1,
            column=0,
            sticky="w",
            pady=(6, 0),
        ...
        self.expression_button = ttk.Button(
            button_frame,
            text="Send Expression",
            command=self._send_expression,
        )
        self.expression_button.grid(row=0, column=1, sticky="w", padx=(8, 0))
        self.action_buttons.append(self.expression_button)
        ...
        self.stop_button.grid(row=0, column=3, sticky="w", padx=(8, 0))
